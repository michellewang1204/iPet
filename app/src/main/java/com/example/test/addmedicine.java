...
//                限制鬧鐘次數
                if(alarm_num>=5){
                    Toast.makeText(addmedicine.this, "Sorry 最多只能設定5個鬧鐘", Toast.LENGTH_LONG).show();
                }
                else {
...
//                    array.add(pendingIntent);
                    ...
                    new Thread(new Runnable(){
                        ...
                        public void run(){
                            ...
                            con.run();
                            con.setAlarm("medicine",pid,hour,minute);
                            check[0] = false;
                        }
                    }
                    ).start();
                ...
                tent1.setClass(addmedicine.this,medicine.class);
//                Bundle bundle = new Bundle();
//                for(int[] alarm:time){
//                    Integer index = 0;
