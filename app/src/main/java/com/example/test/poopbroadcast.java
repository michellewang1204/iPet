...
public class poopbroadcast extends BroadcastReceiver {

    @Override
    public void onReceive(Context context, Intent intent) {
//        long[] vibrate = new long[]{0, 500, 1000, 1500};
        Uri uri = Uri.parse("android.resource://" + context.getPackageName() + "/" +R.raw.dog);
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context , "poop")
                .setSmallIcon(R.drawable.poop)
                .setContentTitle("iPet")
                .setContentText("該帶狗狗去上廁所了")
