...
public class food extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
...
//        Arraylist型態轉換
        ...
        for (Button buts : buttonlist) {
            buts.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    switch (view.getId()) {
                        case R.id.alarm1:
                            Intent intent1 = new Intent(food.this, changefood.class);
                            ...
                            break;
                        case R.id.alarm2:
                            Intent intent2 = new Intent(food.this, changefood.class);
                            ...
                            break;
                        case R.id.alarm3:
                            Intent intent3 = new Intent(food.this, changefood.class);
                            ...
                            break;
                        case R.id.alarm4:
                            Intent intent4 = new Intent(food.this, changefood.class);
                            ...
                            break;
                        case R.id.alarm5:
                            Intent intent5 = new Intent(food.this, changefood.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(food.this, health.class);
                i.putExtras(bundle1);
                startActivity(i);
            }
        });
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (time.size() >= 5) {
                    Toast.makeText(food.this, "Sorry 最多只能設定5個鬧鐘", Toast.LENGTH_LONG).show();
                } else {
                    Intent intent = new Intent();
                    intent.putExtras(bundle1);
                    intent.setClass(food.this, addfood.class);
            ...
            d.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch (view.getId()) {
                        case R.id.delete1:
                            time.remove(0);
                            deleteTime = String.valueOf(food.get(0));
                            food.remove(0);
                            deleteTime = deleteTime+":"+String.valueOf(food.get(0));
                            food.remove(0);
                        ...
                        case R.id.delete2:
                            num = 3;
                            time.remove(1);
                            deleteTime = String.valueOf(food.get(num));
                            food.remove(num);
                            deleteTime = deleteTime+":"+String.valueOf(food.get(num));
                            food.remove(num);
                            deleteTime = deleteTime+":00";
                            food.remove(num);
                            alarm_code = 1;
                    ...
                    bundle1.putIntegerArrayList("food", food);
                    showAlarm(buttonlist, switchlist, layoutlist, text);
                    Intent intent = new Intent(food.this, foodbroadcast.class);
                    PendingIntent pendingIntent = PendingIntent.getBroadcast(food.this, alarm_code, intent, 0);
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            con.run();
                            con.deleteAlarm("food",pid, finalDeleteTime);
                        }
                    }).start();
                }
            });
    ...
    public void setAlarm(ArrayList<int[]> time) {
        ...
        if (time.size() != 0) {
            for (int n = 0; n < time.size(); n++) {
                if (time.get(n)[2] == 0) {
                    PendingIntent pendingIntent = PendingIntent.getBroadcast(food.this, n, intent, 0);
                    AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
        ...
        if (isChecked) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    TimeSql con = new TimeSql();
                    con.run();
                    con.updateAlarm("food", pid, time.get(switch_no[0])[0], time.get(switch_no[0])[1],
                            time.get(switch_no[0])[0], time.get(switch_no[0])[1], 0);
                    check[0] = false;
                }
            }
            ).start();
            food.set(switch_no[0] * 3 + 2, 0);
            bundle1.putIntegerArrayList("food", food);
            AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
            Intent intent = new Intent(this, foodbroadcast.class);
            ...
            food.set(switch_no[0] * 3 + 2, 1);
            bundle1.putIntegerArrayList("food", food);
            Intent intent = new Intent(this, foodbroadcast.class);
            PendingIntent pendingIntent = PendingIntent.getBroadcast(food.this, switch_no[0], intent, 0);
            AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
            alarmManager.cancel(pendingIntent);
        }
    }
