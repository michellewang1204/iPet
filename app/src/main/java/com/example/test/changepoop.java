...
public class changepoop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.changepoop);
            ...
            public void onClick(View view) {
                ...
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        con.run();
                        con.updateAlarm("poop",pid,oh,om,hour,minute,tocheck);
                    }
                }
                ).start();

                poop.set((no_alarm*3),hour);
                poop.set((no_alarm*3+1),minute);

                Intent tent1 = new Intent();
                bundle1.putIntegerArrayList("poop",poop);
                tent1.putExtras(bundle1);
                tent1.setClass(changepoop.this,poop.class);
                startActivity(tent1);
            }
        });
    }
