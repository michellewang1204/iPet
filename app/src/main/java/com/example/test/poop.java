...
public class poop extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
...
//        Arraylist型態轉換
        ...
        for (Button buts : buttonlist) {
            buts.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    switch (view.getId()) {
                        case R.id.alarm1:
                            Intent intent1 = new Intent(poop.this, changepoop.class);
                            ...
                            break;
                        case R.id.alarm2:
                            Intent intent2 = new Intent(poop.this, changepoop.class);
                            ...
                            break;
                        case R.id.alarm3:
                            Intent intent3 = new Intent(poop.this, changepoop.class);
                            ...
                            break;
                        case R.id.alarm4:
                            Intent intent4 = new Intent(poop.this, changepoop.class);
                            ...
                            break;
                        case R.id.alarm5:
                            Intent intent5 = new Intent(poop.this, changepoop.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(poop.this, health.class);
                i.putExtras(bundle1);
                startActivity(i);
            }
        });
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (time.size() >= 5) {
                    Toast.makeText(poop.this, "Sorry 最多只能設定5個鬧鐘", Toast.LENGTH_LONG).show();
                } else {
                    Intent intent = new Intent();
                    intent.putExtras(bundle1);
                    intent.setClass(poop.this, addpooptime.class);
            ...
            d.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    switch (view.getId()) {
                        case R.id.delete1:
                            time.remove(0);
                            deleteTime = String.valueOf(poop.get(0));
                            poop.remove(0);
                            deleteTime = deleteTime+":"+String.valueOf(poop.get(0));
                            poop.remove(0);
                        ...
                        case R.id.delete2:
                            num = 3;
                            time.remove(1);
                            deleteTime = String.valueOf(poop.get(num));
                            poop.remove(num);
                            deleteTime = deleteTime+":"+String.valueOf(poop.get(num));
                            poop.remove(num);
                            deleteTime = deleteTime+":00";
                            poop.remove(num);
                            alarm_code = 1;
                    ...
                    bundle1.putIntegerArrayList("poop", poop);
                    showAlarm(buttonlist, switchlist, layoutlist, text);
                    Intent intent = new Intent(poop.this, poopbroadcast.class);
                    PendingIntent pendingIntent = PendingIntent.getBroadcast(poop.this, alarm_code, intent, 0);
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            con.run();
                            con.deleteAlarm("poop",pid, finalDeleteTime);
                        }
                    }).start();
                }
            });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.addfood:
                intent.putExtras(bundle1);
                intent.setClass(this, addpooptime.class);
                startActivity(intent);
                break;
        }
    ...
    public void setAlarm(ArrayList<int[]> time) {
        ...
        if (time.size() != 0) {
            for (int n = 0; n < time.size(); n++) {
                if (time.get(n)[2] == 0) {
                    PendingIntent pendingIntent = PendingIntent.getBroadcast(poop.this, n, intent, 0);
                    AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
        ...
        if (isChecked) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    TimeSql con = new TimeSql();
                    con.run();
                    con.updateAlarm("poop", pid, time.get(switch_no[0])[0], time.get(switch_no[0])[1],
                            time.get(switch_no[0])[0], time.get(switch_no[0])[1], 0);
                    check[0] = false;
                }
            }
            ).start();
            poop.set(switch_no[0] * 3 + 2, 0);
            bundle1.putIntegerArrayList("poop", poop);
            AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
            Intent intent = new Intent(this, poopbroadcast.class);
            ...
            poop.set(switch_no[0] * 3 + 2, 1);
            bundle1.putIntegerArrayList("poop", poop);
            Intent intent = new Intent(this, poopbroadcast.class);
            PendingIntent pendingIntent = PendingIntent.getBroadcast(poop.this, switch_no[0], intent, 0);
            AlarmManager alarmManager = (AlarmManager) getSystemService(ALARM_SERVICE);
            alarmManager.cancel(pendingIntent);
        }
    }
